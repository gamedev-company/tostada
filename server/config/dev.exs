...
config :tostada, TostadaWeb.Endpoint,
  ...
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:tostada, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:tostada, ~w(--watch)]}
  ]
...
config :tostada, TostadaWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/tostada_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]
