# Tostada Boilerplate TODO

- [x] Fork cards into new `tostada` directory
- [x] Remove game-specific server/client code
- [x] Keep auth + admin backend (users only)
- [x] Keep authenticated socket flow and JS client pipeline
- [x] SvelteKit adapter-static build into Phoenix static + digest flow
